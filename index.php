                ...
                <form action="registration" method="post">
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="first_name" placeholder="First name" value="<?php echo set_value('name'); ?>" class="form-control">
                        </div>
                        <div class="col-md-6">   
                            <?php echo form_error('last_name'); ?>
                            <input type="text" name="last_name" placeholder="Last name" value="<?php echo set_value('name'); ?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">    
