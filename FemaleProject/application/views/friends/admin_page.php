				...
				<div style="background-color:  #AACACD; color: white; padding: 25px; border-radius: 15px;"  >
					<form action="add_event" method="post">
						<div class="form-group">
							...
							<input type="text" name="title" placeholder="the title" class='form-control'><br>
							<textarea name="event" placeholder="the event" class='form-control'></textarea><br>
							<input type="text" name="location" placeholder="the location" class='form-control'><br>
							<input type="date" name="date" class='form-control'><br>
							<div class="input-group">
								<span class="input-group-addon">the Price:</span>	
